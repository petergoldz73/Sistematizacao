    ...
    public void start(Stage primaryStage) {
        ...
        addButton.setOnAction(e -> {
            ...
            if (!name.isEmpty() && !phone.isEmpty() && !email.isEmpty()) {
                contactList.addContact(new br.uniceub.sistematizacao.sistematizacao.Contact(name, phone, email)); // Adiciona o contato à lista
        ...
        searchButton.setOnAction(e -> {
            ...
            if (!searchTerm.isEmpty()) {
                br.uniceub.sistematizacao.sistematizacao.Contact foundContact = contactList.searchContact(searchTerm);
